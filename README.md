...
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 15,929 | 🐛 8 | 🌐 Shell | 📅 2026-02-16
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 437,917 | 🐛 71 | 📅 2026-01-28
...
* [PiShrink](https://github.com/Drewsif/PiShrink/) ⭐ 3,924 | 🐛 31 | 🌐 Shell | 📅 2025-04-20 - Bash script that automatically shrinks a pi image that will then resize to the max size of the SD card on boot.
...
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,650 | 🐛 143 | 🌐 Shell | 📅 2026-02-17 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
* [PiKISS](https://github.com/jmcerrejon/PiKISS) ⭐ 976 | 🐛 27 | 🌐 Shell | 📅 2026-01-17 - A bunch of scripts with menu to make your life easier.
* [sdm](https://github.com/gitbls/sdm) ⭐ 720 | 🐛 16 | 🌐 Shell | 📅 2026-02-16 - Easily and fully customize RasPiOS images. Install apps, configure settings, etc then burn SSDs/SD cards for lots of different systems from a single image, and each one boots up fully configured and ready for work. Or play.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 32,595 | 🐛 1,272 | 🌐 Go | 📅 2026-02-17 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 11,668 | 🐛 314 | 🌐 C++ | 📅 2026-02-04 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 9,774 | 🐛 89 | 📅 2026-02-11 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Circle](https://github.com/rsta2/circle) ⭐ 2,198 | 🐛 17 | 🌐 C | 📅 2026-02-16 - A C++ bare metal environment for Raspberry Pi.
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,550 | 🐛 68 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,131 | 🐛 22 | 🌐 Rust | 📅 2026-02-16 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [Haven](https://github.com/havenweb/haven) ⭐ 755 | 🐛 15 | 🌐 Ruby | 📅 2026-01-26 - Host a private blog on your Rasperry Pi instead of using Facebook.
...
* [Network Presence Detector](https://github.com/initialstate/pi-sensor-free-presence-detector/wiki) ⭐ 376 | 🐛 3 | 🌐 Python | 📅 2017-09-22 - Setup a Pi Zero to scan for devices on a WiFi network and use that to determine who is "home".
...
* [RPi Motor Library](https://github.com/gavinlyonsrepo/RpiMotorLib) ⭐ 332 | 🐛 1 | 🌐 Python | 📅 2025-02-07 - Python 3 library to connect various motors & servos to the Pi.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 27 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-16 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
...
* [Raspberry Pi A to Z List](https://github.com/wtsxDev/Raspberry-Pi) ⭐ 957 | 🐛 0 | 📅 2021-05-15 - Comprehensive list with links to common questions & pitfalls.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 15,929 | 🐛 8 | 🌐 Shell | 📅 2026-02-16
