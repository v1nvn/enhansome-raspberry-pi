...
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 15,884 | 🐛 9 | 🌐 Shell | 📅 2026-02-08
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28
...
* [NextCloudPi](https://github.com/nextcloud/nextcloudpi) ⭐ 2,856 | 🐛 217 | 🌐 Shell | 📅 2025-11-19 - Nextcloud ready image based on Raspbian. Features Nextcloud 11 running on Raspbian 8, with PHP 7 and HTTP2 enabled Apache server.
...
* [DroneBridge](https://github.com/seeul8er/DroneBridge) ⭐ 894 | 🐛 17 | 🌐 C | 📅 2022-01-07 - A WifiBroadcast extension to make for a real alternative to DJI Lightbridge and other similar systems. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
...
* [Mainsail OS](https://github.com/mainsail-crew/MainsailOS) ⭐ 703 | 🐛 4 | 🌐 Shell | 📅 2025-10-30 - A distribution for 3D Printers that includes everything to get started with Klipper Firmware and Mainsail.
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 8,934 | 🐛 296 | 🌐 Python | 📅 2025-08-23 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
* [PiShrink](https://github.com/Drewsif/PiShrink/) ⭐ 3,919 | 🐛 31 | 🌐 Shell | 📅 2025-04-20 - Bash script that automatically shrinks a pi image that will then resize to the max size of the SD card on boot.
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,111 | 🐛 161 | 🌐 Shell | 📅 2025-12-04 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,644 | 🐛 141 | 🌐 Shell | 📅 2026-02-09 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
* [PiKISS](https://github.com/jmcerrejon/PiKISS) ⭐ 975 | 🐛 26 | 🌐 Shell | 📅 2026-01-17 - A bunch of scripts with menu to make your life easier.
* [sdm](https://github.com/gitbls/sdm) ⭐ 716 | 🐛 16 | 🌐 Shell | 📅 2026-02-08 - Easily and fully customize RasPiOS images. Install apps, configure settings, etc then burn SSDs/SD cards for lots of different systems from a single image, and each one boots up fully configured and ready for work. Or play.
* [stressberry](https://github.com/nschloe/stressberry) ⭐ 355 | 🐛 39 | 🌐 Python | 📅 2023-06-17 - Stress test your Raspberry Pi and plot temperatures.
...
* [pistrong](https://github.com/gitbls/pistrong) ⭐ 71 | 🐛 1 | 🌐 Shell | 📅 2025-01-19 - Manage certificate-secured strongSwan VPNs. Installer and command-line tool for client-server, site-to-site, and host-to-host VPNs.
...
* [RaspAP-webgui](https://github.com/billz/raspap-webgui) ⭐ 24 | 🐛 0 | 🌐 PHP | 📅 2025-12-26 - A simple, responsive web interface to control wifi, hostapd and related services on the Raspberry Pi.
...
* [n01d-forge](https://github.com/bad-antics/n01d-forge) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2026-02-05 - Native Rust image burner with LUKS/VeraCrypt encryption support, perfect for creating secure bootable SD cards for Raspberry Pi.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 32,473 | 🐛 1,268 | 🌐 Go | 📅 2026-02-06 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 11,661 | 🐛 314 | 🌐 C++ | 📅 2026-02-04 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 9,762 | 🐛 87 | 📅 2025-12-15 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [P4wnP1](https://github.com/mame82/P4wnP1) ⭐ 4,345 | 🐛 120 | 🌐 Python | 📅 2024-08-12 - P4wnP1 is a highly customizable USB attack platform, based on a low cost Raspberry Pi Zero or Raspberry Pi Zero W (required for HID backdoor). ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
...
* [Circle](https://github.com/rsta2/circle) ⭐ 2,190 | 🐛 16 | 🌐 C | 📅 2026-02-01 - A C++ bare metal environment for Raspberry Pi.
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,550 | 🐛 68 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,115 | 🐛 30 | 🌐 Rust | 📅 2026-02-07 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,077 | 🐛 15 | 🌐 Python | 📅 2025-10-17 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
* [Looper/synth/drum thing](https://github.com/otem/Raspberry-Pi-Looper-synth-drum-thing) ⭐ 1,020 | 🐛 6 | 🌐 C++ | 📅 2021-07-04 - Sequencer/Drumpad, like Native Instruments' Maschine for the Pi.
* [Haven](https://github.com/havenweb/haven) ⭐ 753 | 🐛 15 | 🌐 Ruby | 📅 2026-01-26 - Host a private blog on your Rasperry Pi instead of using Facebook.
* [Sonus](https://github.com/evancohen/sonus) ⭐ 640 | 🐛 36 | 🌐 JavaScript | 📅 2024-07-02 - Node.js voice control for your Pi (and everything else) with customizable offline hotword detection.
...
* [Raspberry Pi Dashboard](https://github.com/femto-code/Raspberry-Pi-Dashboard) ⭐ 352 | 🐛 11 | 🌐 PHP | 📅 2024-06-26 - Full-featured web-based dashboard interface to inspect and manage Raspberry Pi hardware and software, with no extra software required.
...
* [USB Proxy](https://github.com/AristoChen/usb-proxy) ⭐ 249 | 🐛 14 | 🌐 C++ | 📅 2026-02-01 - A USB man-in-the-middle project that allow users to monitor and modify USB packets flow between host and device.
* [Lomorage](https://github.com/lomorage/homepage) ⭐ 237 | 🐛 6 | 🌐 HTML | 📅 2024-11-18 - Private photo cloud host on Raspberry Pi, with Android/iOS/Web client.
...
* [Display\_Lib\_RPI](https://github.com/gavinlyonsrepo/Display_Lib_RPI) ⭐ 39 | 🐛 0 | 🌐 C++ | 📅 2025-10-07 - A shared installable C++ Library to connect various electronic displays to Raspberry Pi single board computers.
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,606 | 🐛 113 | 🌐 C | 📅 2026-02-03 - Nvidia GameStream implementation to stream your full collection of Steam games from desktop to the Raspberry Pi.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 15,884 | 🐛 9 | 🌐 Shell | 📅 2026-02-08
